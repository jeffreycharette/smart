									...
									if ($vv['type']!="tpl" && $kk!="tpl") {
										...
										if ($vv['type']=="textarea" || $vv['type']=="content") {
											if (stristr($editortpl,"{".$vv['name']."}")) {
												...
												$editortpl=str_replace("{".$vv['name'].".sanitize}",print_input($kk,$vv['name'],"",sanitize_filename($vv['value']),"textarea"," id=\"textarea".$kk."\" style=\"width:97%;height:200px;\" rows=\"8\" class=\"textarea\" "),$editortpl);
											}
										...
										elseif ($vv['name']=="dates") {
											...
											if (stristr($editortpl,"{".$vv['name']."}")) {
												...
												$editortpl=str_replace("{".$vv['name'].".sanitize}",print_input($kk,$vv['name'],"",sanitize_filename($vv['value']),"text"," id=\"text".$kk."\" class=\"".$vv['type']."\" "),$editortpl);
											}
											elseif (strlen($vv['name']) > 1) {
