...
$tinybrowser['path']['image'] = '/uploaded/smart/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
...
$tinybrowser['window']['width']  = 765;
$tinybrowser['window']['height'] = 515;
